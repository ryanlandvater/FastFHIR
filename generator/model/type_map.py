...
UK_CORE_RESOURCES: list[str] = [
    ...
    "Condition", "DiagnosticReport", "Encounter", "Immunization", "Location",
...
TYPE_MAP: dict[str, dict] = {
    "boolean":      {"cpp": "uint8_t",  "data_type": "uint8_t",
                     "null": "FF_NULL_UINT8",    "size": 1,
                     "size_const": "TYPE_SIZE_UINT8",   "macro": "LOAD_U8"},
    "integer":      {"cpp": "uint32_t", "data_type": "uint32_t",
                     "null": "FF_NULL_UINT32",  "size": 4,
                     "size_const": "TYPE_SIZE_UINT32",  "macro": "LOAD_U32"},
    "unsignedInt":  {"cpp": "uint32_t", "data_type": "uint32_t",
                     "null": "FF_NULL_UINT32",  "size": 4,
                     "size_const": "TYPE_SIZE_UINT32",  "macro": "LOAD_U32"},
    "positiveInt":  {"cpp": "uint32_t", "data_type": "uint32_t",
                     "null": "FF_NULL_UINT32",  "size": 4,
                     "size_const": "TYPE_SIZE_UINT32",  "macro": "LOAD_U32"},
    "integer64":    {"cpp": "uint64_t", "data_type": "uint64_t",
                     "null": "FF_NULL_UINT64",  "size": 8,
                     "size_const": "TYPE_SIZE_UINT64",  "macro": "LOAD_U64"},
    "decimal":      {"cpp": "double",   "data_type": "double",
                     "null": "FF_NULL_F64",       "size": 8,
                     "size_const": "TYPE_SIZE_FLOAT64", "macro": "LOAD_F64"},
    "code":         {"cpp": "uint32_t", "data_type": "std::string_view",
                     "null": "\"\"",      "size": 4,
                     "size_const": "TYPE_SIZE_UINT32",  "macro": "LOAD_U32"},
    "Resource":     {"cpp": "ResourceReference", "data_type": "ResourceReference",
                     "null": "{}", "size": 10,
                     "size_const": "TYPE_SIZE_RESOURCE", "macro": "LOAD_RESOURCE"},
    "CHOICE":       {"cpp": "ChoiceEntry", "data_type": "ChoiceEntry",
                     "null": "{}", "size": 10,
                     "size_const": "TYPE_SIZE_CHOICE", "macro": "LOAD_VARIANT"},
    "DEFAULT":      {"cpp": "Offset",   "data_type": "Offset",
                     "null": "FF_NULL_OFFSET",    "size": 8,
                     "size_const": "TYPE_SIZE_OFFSET",  "macro": "LOAD_U64"},
}
...
STRING_TYPES: set[str] = {
    "string", "id", "markdown", "uri", "url", "canonical",
    "oid", "base64Binary", "date", "dateTime", "instant", "time", "xhtml",
}
